...
/**
 * JPA entity for transaction data.
 * Migrated from COBOL copybook: CVTRA05Y.cpy (TRAN-RECORD)
 * VSAM file: TRANSACT (RECLN 350)
 */
@Entity
@Table(name = "transaction", indexes = {
    ...
    @Index(name = "idx_transaction_acct_id", columnList = "card_num, orig_timestamp")
})
