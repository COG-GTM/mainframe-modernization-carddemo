...
/**
 * JPA entity for daily transaction staging/input records.
 * Same field structure as Transaction but represents the staging table
 * for batch processing (derived from CVTRA05Y.cpy daily batch input layout).
 */
@Entity
