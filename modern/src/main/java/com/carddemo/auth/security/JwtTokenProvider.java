 ...
 * Replaces COMMAREA-based session state (CDEMO-USER-ID, CDEMO-USER-TYPE,
 * CDEMO-FROM-TRANID, CDEMO-FROM-PROGRAM) with stateless JWT claims.
 * Original XCTL targets: COADM01C (admin), COMEN01C (regular user)
 */
@Component
