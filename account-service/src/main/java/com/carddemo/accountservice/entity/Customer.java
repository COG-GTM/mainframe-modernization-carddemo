...
/**
 * JPA entity mapping CVCUS01Y.cpy CUST-RECORD (500-byte VSAM layout).
 */
@Entity
...
public class Customer {
    ...
    @Column(name = "cust_ssn", precision = 9, scale = 0)
    ...
    @Column(name = "cust_fico_credit_score", precision = 3, scale = 0)
