package com.carddemo.report.model;
...
/**
 * Account entity mapped from COBOL copybook CVACT01Y.cpy (ACCOUNT-RECORD, RECLN=300).
 */
@Entity
@Table(name = "accounts")
public class Account {
    ...
    @Column(name = "acct_curr_bal", precision = 13, scale = 2)
    private BigDecimal acctCurrBal;

    @Column(name = "acct_credit_limit", precision = 13, scale = 2)
    private BigDecimal acctCreditLimit;

    @Column(name = "acct_cash_credit_limit", precision = 13, scale = 2)
    ...
    @Column(name = "acct_curr_cyc_credit", precision = 13, scale = 2)
    private BigDecimal acctCurrCycCredit;

    @Column(name = "acct_curr_cyc_debit", precision = 13, scale = 2)
