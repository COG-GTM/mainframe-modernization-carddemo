...
public class CustomerRecord {
    ...
    public int getCustFicoCreditScore() { return custFicoCreditScore; }
    public void setCustFicoCreditScore(int custFicoCreditScore) { this.custFicoCreditScore = custFicoCreditScore; }
}
