...
/**
 * Maps to REJECT-RECORD in CBTRN02C.
 * Represents a rejected daily transaction written to the DALYREJS file
 * (transaction_rejects table).
 *
 * Contains all original DALYTRAN fields plus validation failure details.
 * COBOL layout: REJECT-TRAN-DATA (350) + VALIDATION-TRAILER (80) = 430 bytes.
 */
@Entity
...
public class TransactionReject {
    ...
    /** WS-VALIDATION-FAIL-REASON PIC 9(04) — e.g. 101, 102, 103 */
    ...
    public void setValidationFailReason(int validationFailReason) {
